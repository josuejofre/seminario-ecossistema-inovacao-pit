...
<body>
  ...
  <main class="deck-viewport" id="viewport">
    ...
    <!-- SLIDE 25: Apresentação da Dinâmica Interativa -->
    <section class="slide" data-slide="25" data-block="Dinâmica" data-speaker="Grupo Inteiro" data-time="5 min">
      <div class="slide-tag">🎮 ATIVIDADE DINÂMICA • EXPERIÊNCIA IMERSIVA DE 2 HORAS</div>
      <h2 class="slide-title">Dinâmica Interativa: <span>O Dilema do Orquestrador no PIT</span></h2>
      <p class="slide-subtitle">
        Para enriquecer as 2 horas de seminário, vamos colocar toda a sala — colegas discentes e professores — na cadeira da liderança de governança do PIT São José dos Campos.
      </p>

      <div class="grid-2">
        <div class="media-frame">
          <img src="assets/ecosystem_dynamic_workshop.jpg" alt="Dinâmica de Sala de Aula UNIFESP PIT" onerror="this.src='https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=1200&auto=format&fit=crop&q=80'">
          <div class="media-caption">
            <span><strong>Workshop Interativo em Sala</strong> • Simulação ao Vivo de Governança</span>
            <span>UNIFESP Campus PIT</span>
          </div>
        </div>

        <div style="display: flex; flex-direction: column; gap: 1rem;">
          <div class="card card-glow-cyan">
            <div class="card-title">Como a Turma Será Dividida (As 4 Hélices):</div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.6rem; font-size: 0.82rem; margin-top: 0.5rem;">
              <div style="background: rgba(255,255,255,0.04); padding: 0.5rem; border-radius: 6px;">
                <strong style="color: var(--cyan-light);">Hélice 1: Academia</strong><br>Docentes e pesquisadores da UNIFESP, ITA e INPE.
              </div>
              <div style="background: rgba(255,255,255,0.04); padding: 0.5rem; border-radius: 6px;">
                <strong style="color: var(--purple-accent);">Hélice 2: Corporações</strong><br>Executivos da Embraer e multinacionais.
              </div>
              <div style="background: rgba(255,255,255,0.04); padding: 0.5rem; border-radius: 6px;">
                <strong style="color: var(--emerald-accent);">Hélice 3: Startups</strong><br>Fundadores acelerados no Nexus Hub.
              </div>
              <div style="background: rgba(255,255,255,0.04); padding: 0.5rem; border-radius: 6px;">
                <strong style="color: var(--amber-accent);">Hélice 4: Governo / Fomento</strong><br>Gestores da Prefeitura, FAPESP e Finep.
              </div>
            </div>
          </div>

          <div class="card card-glow-emerald">
            <div class="card-title">Mecânica da Simulação (15 a 20 minutos):</div>
            <p class="card-desc" style="font-size: 0.84rem;">
              Apresentaremos <strong>3 dilemas de crise reais</strong> vividos pelo PIT SJC. Cada hélice terá 2 minutos para deliberar internamente e votar na opção estratégica. O sistema computará ao vivo o impacto nas 3 métricas vitais de saúde do ecossistema!
            </p>
          </div>
        </div>
      </div>
    ...
    <!-- SLIDE 26: Simulador ao Vivo - A Dinâmica em Ação -->
    <section class="slide" data-slide="26" data-block="Dinâmica" data-speaker="Grupo Inteiro" data-time="15 min">
      <div class="slide-tag">🕹️ SIMULADOR EM TEMPO REAL • PARTICIPAÇÃO DA SALA</div>
      <h2 class="slide-title">Simulador de Decisão Estratégica: <span>O Orquestrador Sob Pressão</span></h2>
      <p class="slide-subtitle">
        Selecione o dilema, ouça as posições das bancadas e vote para recalcular o equilíbrio sistêmico do PIT SJC:
      </p>

      <div class="simulator-container">
        <!-- Dilemma Tabs -->
        <div class="dilemma-tabs">
          <button class="dilemma-btn active" onclick="selectDilemma(1)">Cenário 1: Conflito de PI (Patente vs Artigo)</button>
          <button class="dilemma-btn" onclick="selectDilemma(2)">Cenário 2: O Fundo Internacional com Lock-in</button>
          <button class="dilemma-btn" onclick="selectDilemma(3)">Cenário 3: Fim do Subsídio Público no Nexus</button>
        </div>

        <!-- Dilemma Content Area -->
        <div id="dilemma-text" style="background: rgba(255,255,255,0.03); padding: 1.1rem; border-radius: var(--radius-sm); border-left: 3px solid var(--cyan-light);">
          <div style="font-weight: 700; color: #fff; font-size: 1.05rem; margin-bottom: 0.3rem;" id="dilemma-title">
            Cenário 1: O Conflito de Propriedade Intelectual (Patente Fechada vs Publicação Aberta)
          </div>
          <div style="font-size: 0.88rem; color: #cbd5e1; line-height: 1.5;" id="dilemma-desc">
            Um laboratório da UNIFESP e uma startup do Nexus desenvolveram juntos um algoritmo de rota para drones que reduz em 40% o consumo de bateria. A Embraer oferece financiar R$ 5 milhões para transformar o projeto em escala industrial, porém exige exclusividade total mundial de 10 anos e cláusula de sigilo estrito que proíbe o mestrando da UNIFESP de publicar sua dissertação nos próximos 3 anos. O que o PIT faz?
          </div>
        </div>

        <!-- Decision Options -->
        <div class="dilemma-options">
          <div class="option-card" id="opt-a" onclick="chooseOption('A')">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
              <strong style="color: var(--cyan-light); font-size: 0.95rem;">Opção A: Aceitar a Exigência da Grande Corporação</strong>
              <span class="hero-badge" style="padding: 0.15rem 0.5rem; font-size: 0.7rem;">Pragmática Corporativa</span>
            </div>
            <p style="font-size: 0.82rem; color: var(--text-muted); line-height: 1.45;">
              Garante os R$ 5 milhões imediatos e o produto voando em escala real, mas sacrifica a dissertação acadêmica e gera revolta entre os pesquisadores da universidade.
            </p>
          </div>

          <div class="option-card" id="opt-b" onclick="chooseOption('B')">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
              <strong style="color: var(--purple-accent); font-size: 0.95rem;">Opção B: Orquestrar Acordo de Inovação Aberta Híbrido</strong>
              <span class="hero-badge" style="padding: 0.15rem 0.5rem; font-size: 0.7rem;">Governança Relacional</span>
            </div>
            <p style="font-size: 0.82rem; color: var(--text-muted); line-height: 1.45;">
              O PIT negocia: a corporação tem licença preferencial comercial, o código-fonte essencial é patenteado em cotitularidade e a dissertação é publicada com dados anonimizados após 6 meses.
            </p>
          </div>
        </div>
        ...
        <div class="metrics-gauges">
          <div class="gauge-card">
            <div style="font-size: 0.8rem; color: var(--text-muted);">Coesão e Confiança da Rede</div>
            <div class="gauge-val" id="metric-cohesion" style="color: var(--cyan-light);">75%</div>
            <div style="font-size: 0.72rem; color: var(--text-dim);" id="metric-cohesion-sub">Equilibrado</div>
          </div>
          <div class="gauge-card">
            <div style="font-size: 0.8rem; color: var(--text-muted);">Taxa de Inovação Radical</div>
            <div class="gauge-val" id="metric-innovation" style="color: var(--emerald-accent);">82%</div>
            <div style="font-size: 0.72rem; color: var(--text-dim);" id="metric-innovation-sub">Alto Potencial</div>
          </div>
          <div class="gauge-card">
            <div style="font-size: 0.8rem; color: var(--text-muted);">Sustentabilidade Financeira</div>
            <div class="gauge-val" id="metric-finance" style="color: var(--amber-accent);">68%</div>
            <div style="font-size: 0.72rem; color: var(--text-dim);" id="metric-finance-sub">Atenção ao Caixa</div>
          </div>
        </div>

        <!-- Timer for Dynamic debate -->
        <div style="margin-top: 1rem; display: flex; justify-content: space-between; align-items: center; font-size: 0.82rem;">
          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <span>⏱ Tempo para Debate das Hélices:</span>
            <span id="debate-timer" style="font-family: var(--font-mono); font-weight: 700; color: var(--emerald-accent); font-size: 1rem;">02:00</span>
            <button class="deck-btn" style="padding: 0.2rem 0.5rem; font-size: 0.72rem;" onclick="toggleDebateTimer()">Iniciar Debate</button>
          </div>
          <div id="sim-feedback" style="color: var(--cyan-light); font-weight: 600;">
            Aguardando voto da sala...
          </div>
        </div>
      </div>
    </section>
  ...
  <script>
    ...
    const speakerNotesData = {
      ...
      25: {
        ...
        time: "5 minutos",
        notes: `
          <strong>Lançamento da Dinâmica Interativa:</strong><br>
          • Explique as regras para a turma: divida os discentes presentes em 4 bancadas (Academia, Corporações, Startups, Governo).<br>
          • Avise que eles terão 2 minutos por rodada para discutir e votar na melhor decisão.<br>
          • Garanta a energia e a participação vibrante da sala.
        `
      },
      26: {
        speaker: "Grupo Inteiro",
        time: "15 minutos",
        notes: `
          <strong>Simulação em Tempo Real no Slide:</strong><br>
          • Acione o cronômetro do debate na tela.<br>
          • Conduza a discussão calorosa entre as 4 hélices para cada um dos 3 dilemas.<br>
          • Clique nas opções votadas pela sala para ver os medidores de Coesão, Inovação e Sustentabilidade Financeira mudarem ao vivo!
        `
      },
      27: {
